/* Garde-fou anti-divergence du moteur Lignées (à lancer avant de déployer une modif moteur) :
   engine/lignees-engine.js (chargé par le NAVIGATEUR en <script> classique) DOIT rester
...
const aBytes = readFileSync(new URL("../engine/lignees-engine.js", import.meta.url));
