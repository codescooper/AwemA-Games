...
(function () {
  var KEY = "phc_CMtwC9Tk89U4dCrcft7H3MrHHhmvYgF5WYAMHaskChYB";   // clé projet PostHog (publique, région EU)
  ...
  try {
    ...
    if (/[?&]demo=1/.test(location.search)) return;                     // pas de tracking pour les démos du mode attractif
    ...
    posthog.init(KEY, { api_host: HOST, defaults: "2026-01-30", disable_session_recording: true, autocapture: true, capture_pageview: true, capture_pageleave: true, advanced_disable_decide: true });
